    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < t; i++) {
            ...
            if (ind == -1) {
                ...
                products.get(i).id = (Integer.parseInt(
                        products.get(name.lastIndexOf(products.get(i).getNameId())).getId().substring(2)) + 1);
            }
            name.add(products.get(i).getNameId());
        }
        products.sort((a, b) -> b.getDiscount() - a.getDiscount());
