...
public class J07036_Bang_diem_theo_lop {
    ...
    public static void main(String args[]) throws FileNotFoundException {
        ...
        tables.sort((a, b) -> a.getSubject().getId().equals(b.getSubject().getId()) ? a.getStudent().getId().compareTo(b.getStudent().getId()) : a.getSubject().getId().compareTo(b.getSubject().getId()));
        ...
        while (q-- > 0) {
            ...
            tables.forEach((e) -> {
                if (e.getStudent().getClassName().equals(className))
...
class ScoreTable {
    ...
    @Override
    public String toString() {
        return student + " " + subject + " " + score; // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/OverriddenMethodBody
    }
